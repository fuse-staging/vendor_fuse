...
custom_local_manifest = ".repo/manifests/snippets/fuse.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'raft')
custom_dependencies = "fuse.dependencies"
org_manifest = "FuseOS-Devices"  # leave empty if org is provided in manifest
org_display = "FuseOS-Devices"  # needed for displaying
