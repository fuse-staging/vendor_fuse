...
ALARM_PATH := vendor/fuse/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/fuse/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/fuse/prebuilt/common/media/audio/ringtones
